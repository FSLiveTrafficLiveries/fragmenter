    ...
    moveOverBackedUpFiles(module) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const sd of sourceDirs) {
                const restoreDir = path__default["default"].join(this.options.temporaryDirectory, 'restore', sd);
                const destModuleDir = path__default["default"].join(this.destDir, sd);
    ...
    moveOverExtractedFiles(module) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const sd of sourceDirs) {
                ...
                const subdirName = path__default["default"].basename(sd);
                const absoluteSourceDir = path__default["default"].join(extractedDir, subdirName);
                const destModuleDir = path__default["default"].join(this.destDir, sd);
...
function pack(buildManifest) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const zip = (sourcePath, zipDest) => __awaiter(this, void 0, void 0, function* () {
            ...
            const allFiles = fsReaddirRecursive(sourcePath).map((i) => path__default["default"].resolve(sourcePath, i));
            const crcInfo = {
            ...
            for (const file of allFiles) {
                const relativePath = path__default["default"].relative(sourcePath, file);
                ...
                if (moduleA !== moduleB) {
                    ...
                    for (const sourceA of sourceDirsA) {
                        for (const sourceB of sourceDirsB) {
                            const pathDiff = path__default["default"].relative(sourceA, sourceB);
        ...
        try {
            ...
            for (const module of buildManifest.modules) {
                ...
                const allFiles = sourceDirs.flatMap(dir => fsReaddirRecursive(path__default["default"].join(tempDir, dir)).map(f => path__default["default"].resolve(tempDir, dir, f)));
                ...
                for (const dir of sourceDirs) {
                    const sourcePath = path__default["default"].join(tempDir, dir);
                    const dirName = path__default["default"].basename(dir);
                    const filesInDir = fsReaddirRecursive(sourcePath).map((i) => path__default["default"].resolve(sourcePath, i));
                    ...
                    for (const file of filesInDir) {
                        const relativePath = path__default["default"].relative(sourcePath, file);
                        yield zip.addFile(file, path__default["default"].join(dirName, relativePath));
                    }
                }
                // Archive the zip
                yield zip.archive(zipDest);
