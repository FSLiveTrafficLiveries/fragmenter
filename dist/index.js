...
var require$$0$4 = require('worker_threads');
...
var EventEmitter__default = /*#__PURE__*/_interopDefaultLegacy(EventEmitter$3);
...
exports.FragmenterOperation = void 0;
(function (FragmenterOperation) {
    FragmenterOperation[FragmenterOperation["NotStarted"] = 0] = "NotStarted";
    FragmenterOperation[FragmenterOperation["UpdateCheck"] = 1] = "UpdateCheck";
    FragmenterOperation[FragmenterOperation["InstallBegin"] = 2] = "InstallBegin";
    FragmenterOperation[FragmenterOperation["InstallModuleDownload"] = 3] = "InstallModuleDownload";
    FragmenterOperation[FragmenterOperation["InstallModuleDecompress"] = 4] = "InstallModuleDecompress";
    FragmenterOperation[FragmenterOperation["InstallFinish"] = 5] = "InstallFinish";
    FragmenterOperation[FragmenterOperation["InstallFailRestore"] = 6] = "InstallFailRestore";
    FragmenterOperation[FragmenterOperation["Done"] = 7] = "Done";
})(exports.FragmenterOperation || (exports.FragmenterOperation = {}));

class FragmenterContext extends EventEmitter__default["default"] {
    constructor(options, signal) {
        // eslint-disable-next-line constructor-super
        super();
        this.signal = signal;
        this.phase = { op: exports.FragmenterOperation.NotStarted };
        this.unrecoverableErrorEncountered = false;
        this.options = Object.assign({ useConsoleLog: true, forceCacheBust: false, logTrace: false }, options);
...
function read(root, filter, files, prefix) {
  ...
  var dir = path__default["default"].join(root, prefix);
  if (!fs__default["default"].existsSync(dir)) return files
  if (fs__default["default"].statSync(dir).isDirectory())
    fs__default["default"].readdirSync(dir)
    .filter(function (name, index) {
      return filter(name, index, dir)
    })
    .forEach(function (name) {
      read(root, filter, files, path__default["default"].join(prefix, name));
    });
  else
    files.push(prefix);
...
var Writable$2 = require$$0__default["default"].Writable;
...
const DEFAULT_SPLIT_FILE_SIZE = 1073741824;
 ...
 */
function getLoggerSettingsFromOptions(options) {
    var _a, _b, _c;
    return [(_a = options === null || options === void 0 ? void 0 : options.useConsoleLog) !== null && _a !== void 0 ? _a : true, (_b = options === null || options === void 0 ? void 0 : options.useConsoleLog) !== null && _b !== void 0 ? _b : true, (_c = options === null || options === void 0 ? void 0 : options.useConsoleLog) !== null && _c !== void 0 ? _c : true];
}

class FragmenterUpdateChecker extends EventEmitter__default["default"] {
    /**
     ...
     */
    needsUpdate(source, destDir, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const installManifestPath = path__default["default"].join(destDir, INSTALL_MANIFEST);
            let existingInstall;
            let url = urlJoin(source, MODULES_MANIFEST);
            if (options === null || options === void 0 ? void 0 : options.forceCacheBust) {
                url += `?cache=${Math.random() * 999999999}`;
            }
            logInfo('Downloading module info from', url);
            const response = yield axios.get(url, { responseType: 'json' });
            ...
            if (lib$1.existsSync(installManifestPath)) {
                existingInstall = yield lib$1.readJSON(installManifestPath);
 ...
 */
function getCurrentInstall(destDir) {
    const installManifestPath = path__default["default"].join(destDir, INSTALL_MANIFEST);
    return lib$1.readJSONSync(installManifestPath);
}

exports.FragmenterErrorCode = void 0;
(function (FragmenterErrorCode) {
    FragmenterErrorCode[FragmenterErrorCode["Null"] = 0] = "Null";
    FragmenterErrorCode[FragmenterErrorCode["PermissionsError"] = 1] = "PermissionsError";
    FragmenterErrorCode[FragmenterErrorCode["ResourcesBusy"] = 2] = "ResourcesBusy";
    FragmenterErrorCode[FragmenterErrorCode["NoSpaceOnDevice"] = 3] = "NoSpaceOnDevice";
    FragmenterErrorCode[FragmenterErrorCode["MaxModuleRetries"] = 4] = "MaxModuleRetries";
    FragmenterErrorCode[FragmenterErrorCode["FileNotFound"] = 5] = "FileNotFound";
    FragmenterErrorCode[FragmenterErrorCode["DirectoryNotEmpty"] = 6] = "DirectoryNotEmpty";
    FragmenterErrorCode[FragmenterErrorCode["NotADirectory"] = 7] = "NotADirectory";
    FragmenterErrorCode[FragmenterErrorCode["ModuleJsonInvalid"] = 8] = "ModuleJsonInvalid";
    FragmenterErrorCode[FragmenterErrorCode["ModuleCrcMismatch"] = 9] = "ModuleCrcMismatch";
    FragmenterErrorCode[FragmenterErrorCode["UserAborted"] = 10] = "UserAborted";
    FragmenterErrorCode[FragmenterErrorCode["NetworkError"] = 11] = "NetworkError";
    FragmenterErrorCode[FragmenterErrorCode["CorruptedZipFile"] = 12] = "CorruptedZipFile";
    FragmenterErrorCode[FragmenterErrorCode["Unknown"] = 13] = "Unknown";
})(exports.FragmenterErrorCode || (exports.FragmenterErrorCode = {}));
class FragmenterError extends Error {
    constructor(code, message, fromError) {
        super(fromError === null || fromError === void 0 ? void 0 : fromError.message);
        this.code = code;
        this.message = message;
        this.fromError = fromError;
    }
    static isFragmenterError(error) {
        var _a;
        return (_a = error === null || error === void 0 ? void 0 : error.message) === null || _a === void 0 ? void 0 : _a.includes('FragmenterError(');
    }
    static createFromError(e) {
        const code = this.interpretNodeException(e);
        return new FragmenterError(code, `FragmenterError(${exports.FragmenterErrorCode[code]}): ${e.message}`, e);
    }
    static create(code, message) {
        return new FragmenterError(code, `FragmenterError(${exports.FragmenterErrorCode[code]}): ${message}`);
    }
    static parseFromMessage(message) {
        ...
        const code = exports.FragmenterErrorCode[codeString];
        if (typeof code !== 'number') {
            throw new Error('Could not parse FragmenterError: unknown code string');
        }
        return FragmenterError.create(code, messageString);
    }
    static interpretNodeException(e) {
        var _a;
        if (CorruptedZipMessages.includes(e.message.trim())) {
            return exports.FragmenterErrorCode.CorruptedZipFile;
        }
        const errorCode = (_a = e.code) !== null && _a !== void 0 ? _a : e.message;
        switch (errorCode) {
            case 'EACCES':
            case 'EPERM':
                return exports.FragmenterErrorCode.PermissionsError;
            case 'EBUSY':
                return exports.FragmenterErrorCode.ResourcesBusy;
            case 'ENOSPC':
                return exports.FragmenterErrorCode.NoSpaceOnDevice;
            case 'ENOENT':
                return exports.FragmenterErrorCode.FileNotFound;
            case 'ENOTEMPTY':
                return exports.FragmenterErrorCode.DirectoryNotEmpty;
            case 'ENOTDIR':
                return exports.FragmenterErrorCode.NotADirectory;
            case 'ECONNRESET':
            case 'ENOTFOUND':
                return exports.FragmenterErrorCode.NetworkError;
            default:
                return exports.FragmenterErrorCode.Unknown;
        }
    }
}
const UnrecoverableErrors = [
    exports.FragmenterErrorCode.PermissionsError,
    exports.FragmenterErrorCode.NoSpaceOnDevice,
    exports.FragmenterErrorCode.MaxModuleRetries,
    exports.FragmenterErrorCode.FileNotFound,
    exports.FragmenterErrorCode.DirectoryNotEmpty,
    exports.FragmenterErrorCode.NotADirectory,
];
...
class StreamDownloader extends EventEmitter__default["default"] {
    constructor(ctx, downloadUrl) {
        // eslint-disable-next-line constructor-super
        super();
        this.ctx = ctx;
        this.downloadUrl = downloadUrl;
    }
    downloadFrom(startIndex, writeStream) {
        return __awaiter(this, void 0, void 0, function* () {
            const ret = {
                bytesWritten: 0,
                error: undefined,
            ...
            try {
                ...
                downloadStream = yield this.getReadStream(startIndex, this.downloadUrl);
            }
            catch (e) {
                this.emit('error', e);
            ...
            try {
                yield new Promise((resolve, reject) => {
                    ...
                    downloadStream.data.on('close', () => {
                        if (this.ctx.signal.aborted) {
                            reject(FragmenterError.create(exports.FragmenterErrorCode.UserAborted, 'AbortSignal triggered'));
                        }
                    });
                    downloadStream.data.on('data', (buffer) => {
                ...
                if (FragmenterError.isFragmenterError(e) && UnrecoverableErrors.includes(e.code)) {
                    this.ctx.logError(`[StreamDownloader] stream download error is unrecoverable (${exports.FragmenterErrorCode[e.code]}) - not trying to resume the download`);
...
class FileDownloader extends EventEmitter__default["default"] {
    constructor(ctx, fileUrl, forceCacheBust) {
        // eslint-disable-next-line constructor-super
        super();
        this.ctx = ctx;
        this.fileUrl = fileUrl;
        this.forceCacheBust = forceCacheBust;
    }
    download(dest) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headData = yield FileDownloader.getHeaders(url);
            let fileSize;
            ...
            const serverSupportsRanges = (_b = (_a = headData.headers['accept-ranges']) === null || _a === void 0 ? void 0 : _a.includes('bytes')) !== null && _b !== void 0 ? _b : false;
            ...
            if (serverSupportsRanges) {
                ...
                while (retryCount < 5) {
                    const writeStream = lib$1.createWriteStream(dest, { flags: 'a' });
                    const { bytesWritten, error, } = yield fileStreamDownloader.downloadFrom(loadedBytes, writeStream);
                    ...
                    if (loadedBytes >= fileSize) {
                        ...
                        if (this.ctx.signal.aborted) {
                            throw FragmenterError.create(exports.FragmenterErrorCode.UserAborted, 'AbortSignal triggered');
                        }
                        ...
                        this.ctx.logInfo(`[FileDownloader] file not entirely downloaded (${downloadPercentage}%) - retrying in ${Math.pow(2, retryCount)}s`);
                    }
                    retryCount++;
                    yield timer(Math.pow(2, retryCount) * 1000);
                }
                if (loadedBytes < fileSize) {
                    if (!ret.error) {
                        ret.error = FragmenterError.create(exports.FragmenterErrorCode.MaxModuleRetries, 'File not entirely downloaded - max number of download resumes reached or unrecoverable error detected');
                    }
                }
            }
            else {
                ...
                while (retryCount < 5) {
                    const writeStream = lib$1.createWriteStream(dest, { flags: 'a' });
                    const { bytesWritten, error, } = yield fileStreamDownloader.downloadFrom(0, writeStream);
                    loadedBytes = bytesWritten;
                    if (loadedBytes >= fileSize) {
                        break;
                    }
                ...
                if (loadedBytes < fileSize) {
                    if (!ret.error) {
                        ret.error = FragmenterError.create(exports.FragmenterErrorCode.MaxModuleRetries, 'File not entirely downloaded - max number of download restarts reached');
                    }
                }
            }
...
class ModuleDownloader extends EventEmitter__default["default"] {
    constructor(ctx, baseUrl, module, moduleIndex, retryCount, fullModuleHash) {
        // eslint-disable-next-line constructor-super
        super();
        this.ctx = ctx;
        ...
        this.fullModuleHash = fullModuleHash;
    }
    startDownload(destDir) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ctx.currentPhase = { op: exports.FragmenterOperation.InstallModuleDownload, module: this.module, moduleIndex: this.moduleIndex };
            this.probedModuleFileSize = yield this.probeModuleCompleteFileSize();
            ...
            if (Number.isFinite(moduleSplitFileCount) && moduleSplitFileCount > 0) {
                ...
                yield this.downloadModuleFileParts(destDir);
                ...
                const ret = yield this.downloadModuleFile(destDir);
                this.ctx.logTrace(`[ModuleDownloader] Done downloading module file '${this.module.name}'`);
                return ret;
            }
        });
    }
    probeModuleCompleteFileSize() {
        return __awaiter(this, void 0, void 0, function* () {
            const fileName = `${this.module.name}.zip`;
            const url = urlJoin(this.baseUrl, fileName);
            let headers;
            try {
                headers = (yield axios.head(url)).headers;
    ...
    downloadModuleFile(destDir) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            downloader.on('progress', (loaded) => {
                ...
                this.emit('progress', {
                    loaded,
                    total: (_a = this.probedModuleFileSize) !== null && _a !== void 0 ? _a : this.module.completeFileSize,
            ...
            const filePath = path__default["default"].join(destDir, `${this.module.name}.zip`);
            try {
                const { error } = yield downloader.download(filePath);
                if (error) {
                    throw error;
                }
                return true;
                ...
                try {
                    yield lib$1.access(filePath);
                    yield util$1.promisify(lib$1.rm)(filePath);
                }
                catch (e) {
                    // noop
                }
    ...
    downloadModuleFileParts(destDir) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < numParts; i++) {
                ...
                const filePath = path__default["default"].join(destDir, `${this.module.name}.zip.fg-tmp${partIndexString}`);
                try {
                    const { bytesDownloaded, error } = yield partDownloader.download(filePath);
                    if (error) {
                        throw error;
                    }
    ...
    mergeModuleFileParts(destDir) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ctx.logInfo(`[ModuleDownloader] Merging ${this.module.splitFileCount} file parts for module '${this.module.name}'`);
            const numParts = this.module.splitFileCount;
            for (let i = 0; i < numParts; i++) {
                const completeModuleFileWriteStream = lib$1.createWriteStream(path__default["default"].join(destDir, `${this.module.name}.zip`), { flags: 'a' });
                const partIndexString = (i + 1).toString()
                    .padStart(numParts.toString().length, '0');
                const filePath = path__default["default"].join(destDir, `${this.module.name}.zip.fg-tmp${partIndexString}`);
                try {
                ...
                const partFileReadStream = lib$1.createReadStream(filePath);
                try {
                    yield new Promise((resolve, reject) => {
                    ...
                    if (FragmenterError.isFragmenterError(e) && UnrecoverableErrors.includes(e.code)) {
                        this.ctx.logError(`[ModuleDownloader] File merge error is unrecoverable (${exports.FragmenterErrorCode[e.code]}) - not trying to resume the download`);
                        return false;
                    }
                }
                finally {
...
var PassThrough$2 = require$$0__default["default"].PassThrough;


var EventEmitter$2 = EventEmitter__default["default"].EventEmitter;
var crc32 = bufferCrc32;

var ZipFile_1$1 = ZipFile$1;
var dateToDosDateTime_1 = dateToDosDateTime;

util__default["default"].inherits(ZipFile$1, EventEmitter$2);
function ZipFile$1() {
  this.outputStream = new PassThrough$2();
  this.entries = [];
...
ZipFile$1.prototype.addFile = function(realPath, metadataPath, options) {
  ...
  fs__default["default"].stat(realPath, function(err, stats) {
    ...
    entry.setFileDataPumpFunction(function() {
      var readStream = fs__default["default"].createReadStream(realPath);
...
ZipFile$1.prototype.addReadStream = function(readStream, metadataPath, options) {
  var self = this;
  metadataPath = validateMetadataPath(metadataPath, false);
  if (options == null) options = {};
  var entry = new Entry$1(metadataPath, false, options);
...
ZipFile$1.prototype.addBuffer = function(buffer, metadataPath, options) {
  var self = this;
  metadataPath = validateMetadataPath(metadataPath, false);
  ...
  if (!entry.compress) {
    ...
    zlib__default["default"].deflateRaw(buffer, function(err, compressedBuffer) {
...
function pumpFileDataReadStream(self, entry, readStream) {
  ...
  var compressor = entry.compress ? new zlib__default["default"].DeflateRaw() : new PassThrough$2();
...
function pumpEntries(self) {
  ...
  function getFirstNotDoneEntry() {
    for (var i = 0; i < self.entries.length; i++) {
      ...
      if (entry.state < Entry$1.FILE_DATA_DONE) return entry;
    }
    return null;
  }
  if (entry != null) {
    // this entry is not done yet
    if (entry.state < Entry$1.READY_TO_PUMP_FILE_DATA) return; // input file not open yet
    if (entry.state === Entry$1.FILE_DATA_IN_PROGRESS) return; // we'll get there
...
util__default["default"].inherits(ByteCounter, Transform$1);
...
util__default["default"].inherits(Crc32Watcher, Transform$1);
...
var cp437$1 = '\u0000☺☻♥♦♣♠•◘○◙♂♀♪♫☼►◄↕‼¶§▬↨↑↓→←∟↔▲▼ !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~⌂ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜ¢£¥₧ƒáíóúñÑªº¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ';
...
var yazl = {
	ZipFile: ZipFile_1$1,
	dateToDosDateTime: dateToDosDateTime_1
};
...
function unlink(path) {
    return util__default["default"].promisify(fs__default["default"].unlink)(path);
}
exports.unlink = unlink;
function mkdir(path, mode) {
    return util__default["default"].promisify(fs__default["default"].mkdir)(path, mode);
}
exports.mkdir = mkdir;
function realpath(path) {
    return util__default["default"].promisify(fs__default["default"].realpath)(path);
}
exports.realpath = realpath;
function stat(path) {
    return util__default["default"].promisify(fs__default["default"].stat)(path);
}
exports.stat = stat;
function lstat(path) {
    return util__default["default"].promisify(fs__default["default"].lstat)(path);
}
exports.lstat = lstat;
function chmod(path, mode) {
    return util__default["default"].promisify(fs__default["default"].chmod)(path, mode);
}
exports.chmod = chmod;
function readdir(path) {
    return util__default["default"].promisify(fs__default["default"].readdir)(path);
}
exports.readdir = readdir;
function access(path, mode) {
    return util__default["default"].promisify(fs__default["default"].access)(path, mode);
}
exports.access = access;
function rmdir(path) {
    return util__default["default"].promisify(fs__default["default"].rmdir)(path);
}
exports.rmdir = rmdir;
function symlink(target, path, type) {
    return util__default["default"].promisify(fs__default["default"].symlink)(target, path, type);
}
exports.symlink = symlink;
function readlink(path) {
    return util__default["default"].promisify(fs__default["default"].readlink)(path);
}
...
async function readdirp(folder) {
    const result = [];
    const files = await util_1.readdir(folder);
    for (const item of files) {
        const file = path__default["default"].join(folder, item);
...
async function getFileEntry(target) {
    const stat = await util_1.lstat(target);
    ...
    if (stat.isDirectory()) {
        ...
        if (stat.isSymbolicLink()) {
            ...
            const actualStat = await util_1.stat(target);
...
async function ensureFolder(folder) {
    // stop at root
    if (folder === path__default["default"].dirname(folder)) {
    ...
    try {
        ...
        if (error.code === "ENOENT") {
            await ensureFolder(path__default["default"].dirname(folder));
            return mkdir(folder);
        }
        // Any other error
        return Promise.reject(error);
...
async function rimraf(target) {
    ...
    try {
        ...
        if (stat.isDirectory() && !stat.isSymbolicLink()) {
            // Children
            const children = await util_1.readdir(target);
            await Promise.all(children.map(child => rimraf(path__default["default"].join(target, child))));
            // Folder
            await util_1.rmdir(target);
        }
        // Single file delete
        else {
            ...
            if (!(mode & 128)) { // 128 === 0200
                await util_1.chmod(target, mode | 128);
            }
            return util_1.unlink(target);
        }
    }
    catch (error) {
        if (error.code !== "ENOENT") {
...
async function mkdir(folder) {
    try {
        await util_1.mkdir(folder, 0o777);
    }
    catch (error) {
        ...
        try {
            const fileStat = await util_1.stat(folder);
...
var cancelable = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
 ...
 */
class Zip extends cancelable.Cancelable {
    /**
     *
     */
    constructor(options) {
    ...
    addFile(file, metadataPath) {
        ...
        if (!mpath) {
            mpath = path__default["default"].basename(file);
        }
        this.zipFiles.push({
            path: file,
            metadataPath: mpath
    ...
    async archive(zipFile) {
        ...
        const token = new cancelable.CancellationToken();
        this.token = token;
        this.isPipe = false;
        await fs.ensureFolder(path__default["default"].dirname(zipFile));
        ...
        return new Promise(async (c, e) => {
            ...
            if (!token.isCancelled) {
                this.zipStream = (0, fs__default["default"].createWriteStream)(zipFile);
            ...
            try {
                ...
                for (const file of files) {
                    const entry = await fs.getFileEntry(file.path);
    ...
    async addEntry(zip, entry, file, token) {
        if (entry.isSymbolicLink) {
            if (this.followSymlink()) {
                if (entry.type === "dir") {
                    const realPath = await util_1.realpath(file.path);
    ...
    addFileStream(zip, file, metadataPath, token) {
        return new Promise((c, e) => {
            const fileStream = (0, fs__default["default"].createReadStream)(file.path);
    ...
    async addSymlink(zip, file, metadataPath) {
        const linkTarget = await util_1.readlink(file.path);
    ...
    async walkDir(folders, token) {
        for (const folder of folders) {
            ...
            const entries = await fs.readdirp(folder.path);
            if (entries.length > 0) {
                for (const entry of entries) {
                    if (token.isCancelled) {
                        return;
                    }
                    const relativePath = path__default["default"].relative(folder.path, entry.path);
                    const metadataPath = folder.metadataPath ? path__default["default"].join(folder.metadataPath, relativePath) : relativePath;
...
var PassThrough$1 = require$$0__default["default"].PassThrough;

var EventEmitter$1 = EventEmitter__default["default"].EventEmitter;
...
util__default["default"].inherits(FdSlicer, EventEmitter$1);
...
FdSlicer.prototype.read = function(buffer, offset, length, position, callback) {
  ...
  self.pend.go(function(cb) {
    fs__default["default"].read(self.fd, buffer, offset, length, position, function(err, bytesRead, buffer) {
      cb();
...
FdSlicer.prototype.write = function(buffer, offset, length, position, callback) {
  var self = this;
  self.pend.go(function(cb) {
    fs__default["default"].write(self.fd, buffer, offset, length, position, function(err, written, buffer) {
      cb();
...
FdSlicer.prototype.unref = function() {
  ...
  if (self.autoClose) {
    fs__default["default"].close(self.fd, onCloseDone);
  }
...
util__default["default"].inherits(ReadStream, Readable);
...
ReadStream.prototype._read = function(n) {
  ...
  self.context.pend.go(function(cb) {
    ...
    fs__default["default"].read(self.context.fd, buffer, 0, toRead, self.pos, function(err, bytesRead) {
      if (err) {
        self.destroy(err);
      } else if (bytesRead === 0) {
        self.destroyed = true;
...
util__default["default"].inherits(WriteStream, Writable$1);
...
WriteStream.prototype._write = function(buffer, encoding, callback) {
  ...
  self.context.pend.go(function(cb) {
    if (self.destroyed) return cb();
    fs__default["default"].write(self.context.fd, buffer, 0, buffer.length, self.pos, function(err, bytes) {
      if (err) {
        self.destroy();
        cb();
        callback(err);
...
util__default["default"].inherits(BufferSlicer, EventEmitter$1);
...
function open(path, options, callback) {
  ...
  fs__default["default"].open(path, "r", function(err, fd) {
    if (err) return callback(err);
    fromFd(fd, options, function(err, zipfile) {
      if (err) fs__default["default"].close(fd, defaultCallback);
...
function fromFd(fd, options, callback) {
  ...
  if (options.strictFileNames == null) options.strictFileNames = false;
  if (callback == null) callback = defaultCallback;
  fs__default["default"].fstat(fd, function(err, stats) {
    if (err) return callback(err);
...
util__default["default"].inherits(ZipFile, EventEmitter);
...
ZipFile.prototype.openReadStream = function(entry, options, callback) {
  ...
  readAndAssertNoEof(self.reader, buffer, 0, buffer.length, entry.relativeOffsetOfLocalHeader, function(err) {
    try {
      ...
      if (decompress) {
        var destroyed = false;
        var inflateFilter = zlib__default["default"].createInflateRaw();
        readStream.on("error", function(err) {
...
util__default["default"].inherits(AssertByteCountStream, Transform);
...
util__default["default"].inherits(RandomAccessReader, EventEmitter);
...
util__default["default"].inherits(RefUnrefFilter, PassThrough);
...
var unzip = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
class EntryContext {
    ...
    getFilePath() {
        return path__default["default"].join(this.targetFolder, this.decodeEntryFileName);
    }
    async isOutsideTargetFolder(tpath) {
        ...
        for (const fileName of this.symlinkFileNames) {
            if (tpath.includes(fileName)) {
                const realFilePath = await util_1.realpath(tpath);
 ...
 */
class Unzip extends cancelable.Cancelable {
    /**
     *
     */
    constructor(options) {
    ...
    async extract(zipFile, targetFolder) {
        ...
        this.token = token;
        if (this.isOverwrite()) {
            await fs.rimraf(targetFolder);
        }
        if (token.isCancelled) {
            return Promise.reject(this.canceledError());
        }
        await fs.ensureFolder(targetFolder);
        const realTargetFolder = await util_1.realpath(targetFolder);
    ...
    async handleEntry(zfile, entry, entryContext, token) {
        if (/\/$/.test(entryContext.decodeEntryFileName)) {
            ...
            await fs.ensureFolder(entryContext.getFilePath());
            zfile.readEntry();
        }
        else {
            // file entry
        ...
        return new Promise(async (c, e) => {
            try {
                ...
                if (isSymlink && !this.symlinkToFile()) {
                    ...
                    fileStream = (0, fs__default["default"].createWriteStream)(filePath, { mode });
    ...
    async createSymlink(linkContent, des) {
        ...
        if (process.platform === 'win32') {
            if (/\/$/.test(linkContent)) {
                ...
                if (!path__default["default"].isAbsolute(linkContent)) {
                    targetPath = path__default["default"].join(path__default["default"].dirname(des), linkContent);
                }
                try {
                    const stat = await util_1.stat(targetPath);
                    if (stat.isDirectory()) {
                        linkType = "dir";
                    }
                }
        ...
        await util_1.symlink(linkContent, des, linkType);
    }
    isOverwrite() {
        if (this.options &&
...
function archiveFile(file, zipFile, options) {
    const zip$1 = new zip.Zip(options);
    zip$1.addFile(file);
    return zip$1.archive(zipFile);
}
...
function extract(zipFile, targetFolder, options) {
    const unzip$1 = new unzip.Unzip(options);
    return unzip$1.extract(zipFile, targetFolder);
}
exports.extract = extract;
});

class ModuleDecompressor extends EventEmitter__default["default"] {
    constructor(ctx, module, moduleIndex) {
        // eslint-disable-next-line constructor-super
        super();
        this.ctx = ctx;
        this.module = module;
    ...
    decompress(filePath, destDir) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ctx.currentPhase = { op: exports.FragmenterOperation.InstallModuleDecompress, module: this.module, moduleIndex: this.moduleIndex };
            let entryIndex = 0;
            const unzip = new lib.Unzip({
                onEntry: ({ entryName, entryCount }) => {
                    entryIndex++;
            ...
            try {
                ...
                yield unzip.extract(filePath, destDir);
            ...
            const moduleJsonPath = path__default["default"].join(destDir, 'module.json');
            let moduleJson;
            try {
                const contents = (yield lib$1.readFile(moduleJsonPath)).toString();
            ...
            if (actualCrc !== expectedCrc) {
                throw FragmenterError.create(exports.FragmenterErrorCode.ModuleCrcMismatch, `expected: ${expectedCrc.substring(0, 8)}, read: ${actualCrc.substring(0, 8)}`);
            }
...
class FragmenterInstaller extends EventEmitter__default["default"] {
    constructor(ctx, baseUrl, destDir, options) {
        // eslint-disable-next-line constructor-super
        super();
        this.ctx = ctx;
        this.baseUrl = baseUrl;
        this.destDir = destDir;
        this.options = Object.assign({ temporaryDirectory: path__default["default"].join(os__namespace.tmpdir(), `${DEFAULT_TEMP_DIRECTORY_PREFIX}-${(Math.random() * 1000000).toFixed(0)}`), maxModuleRetries: 5, forceFreshInstall: false, disableFallbackToFull: false }, options);
    }
    install() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.doInstall();
            }
            catch (e) {
                if (FragmenterError.isFragmenterError(e) && e.code === exports.FragmenterErrorCode.UserAborted) {
                ...
                try {
                    yield lib$1.access(path__default["default"].join(this.options.temporaryDirectory, 'restore'));
                ...
                if (backedUpInstallFilesExist) {
                    this.ctx.currentPhase = { op: exports.FragmenterOperation.InstallFailRestore };
                    try {
                        yield this.ensureDestDirIsEmpty();
                        yield this.restoreBackedUpFiles();
                    }
                    catch (e) {
                ...
                this.ctx.currentPhase = { op: exports.FragmenterOperation.Done };
                yield this.ensureTempDirRemoved();
            }
        });
    }
    doInstall() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.ctx.currentPhase = { op: exports.FragmenterOperation.UpdateCheck };
            let updateInfo;
            try {
                updateInfo = yield updater.needsUpdate(this.baseUrl, this.destDir, Object.assign(Object.assign({}, this.options), { forceCacheBust: this.ctx.options.forceCacheBust || this.options.forceManifestCacheBust }));
            }
            catch (e) {
                this.ctx.logError('[FragmenterInstaller] Error while checking for updates. See exception below');
                throw e;
            }
            this.ctx.currentPhase = { op: exports.FragmenterOperation.InstallBegin };
            ...
            let newInstallManifest;
            const allUpdated = updateInfo.updatedModules.length + updateInfo.removedModules.length === ((_a = updateInfo.existingManifest) === null || _a === void 0 ? void 0 : _a.modules.length);
            if (allUpdated || updateInfo.willFullyReDownload || updateInfo.isFreshInstall) {
                ...
                newInstallManifest = yield this.performFullInstall(updateInfo);
            }
            else {
                this.ctx.logInfo('[FragmenterInstaller] Not all modules need update - performing modular update');
                newInstallManifest = yield this.performModularUpdate(updateInfo);
            }
            return this.finishInstall(newInstallManifest);
        });
    }
    performFullInstall(updateInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            this.emit('fullDownload');
            yield this.ensureTempDirExists();
            yield this.backupExistingFiles();
            yield this.ensureDestDirIsEmpty();
            const fullModule = {
                name: 'full',
                sourceDir: '.',
            ...
            yield this.downloadAndInstallModule(fullModule, 0, updateInfo.distributionManifest.fullHash);
            this.ctx.currentPhase = { op: exports.FragmenterOperation.InstallFinish };
            return Object.assign(Object.assign({}, updateInfo.distributionManifest), { source: this.baseUrl });
        });
    }
    performModularUpdate(updateInfo) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            let moduleIndex = 0;
            ...
            if (updateInfo.baseChanged) {
                ...
                try {
                    ...
                    yield this.downloadAndInstallModule(baseModule, moduleIndex, updateInfo.distributionManifest.fullHash, false);
                    moduleIndex++;
                    const { files } = updateInfo.distributionManifest.base;
                    this.emit('copyStarted', baseModule);
                    let moved = 0;
                    for (const file of files) {
                        const absoluteSourcePath = path__default["default"].join(this.options.temporaryDirectory, 'extract', 'base', file);
                        const absoluteDestPath = path__default["default"].join(this.destDir, file);
                        try {
                            yield lib$1.move(absoluteSourcePath, absoluteDestPath, { overwrite: true });
                    ...
                    const isMaxRetriesReached = FragmenterError.isFragmenterError(e) && e.code === exports.FragmenterErrorCode.MaxModuleRetries;
                    if (isMaxRetriesReached && !((_a = this.options) === null || _a === void 0 ? void 0 : _a.disableFallbackToFull)) {
                ...
                let moved = 0;
                for (const file of files) {
                    const absoluteSourcePath = path__default["default"].resolve(this.options.temporaryDirectory, 'restore', file);
                    const absoluteDestPath = path__default["default"].resolve(this.destDir, file);
                    try {
                        yield lib$1.move(absoluteSourcePath, absoluteDestPath, { overwrite: true });
                        this.emit('copyProgress', baseModule, { moved: ++moved, total: files.length });
                    }
            ...
            try {
                for (const module of [...updateInfo.updatedModules, ...updateInfo.addedModules]) {
                    ...
                    yield this.downloadAndInstallModule(newModule, moduleIndex, updateInfo.distributionManifest.fullHash);
                    moduleIndex++;
                }
                this.ctx.currentPhase = { op: exports.FragmenterOperation.InstallFinish };
                for (const module of updateInfo.unchangedModules) {
                    ...
                    yield this.moveOverBackedUpFiles(module);
                }
                ...
                const isMaxRetriesReached = FragmenterError.isFragmenterError(error) && error.code === exports.FragmenterErrorCode.MaxModuleRetries;
                if (isMaxRetriesReached && !((_b = this.options) === null || _b === void 0 ? void 0 : _b.disableFallbackToFull)) {
                    return this.performFullInstall(updateInfo);
                }
                throw error;
            }
    ...
    downloadAndInstallModule(module, moduleIndex, fullModuleHash, move = true) {
        return __awaiter(this, void 0, void 0, function* () {
            let retryCount = 0;
            while (retryCount < 5) {
                try {
                    yield this.tryDownloadAndInstallModule(module, moduleIndex, retryCount, fullModuleHash, move);
                    return;
                }
                catch (e) {
                    if (FragmenterError.isFragmenterError(e)) {
                        ...
                        throw FragmenterError.create(exports.FragmenterErrorCode.UserAborted, 'AbortSignal triggered after retry scheduled');
                    }
                    else {
                        const fragmenterError = FragmenterError.createFromError(e);
                        if (UnrecoverableErrors.includes(fragmenterError.code)) {
                            this.ctx.logError(`[FragmenterInstaller] Unrecoverable error (${exports.FragmenterErrorCode[fragmenterError.code]}) encountered during module '${module.name}' download and install`);
                            throw fragmenterError;
                        }
                        this.emit('error', e);
                    }
                    retryCount++;
                    const retryIn = Math.pow(2, retryCount);
                    this.emit('retryScheduled', module, retryCount - 1, retryIn);
                    this.ctx.logInfo(`[ModuleDownloader] Retrying module in ${retryIn}`);
                    yield timer(retryIn * 1000);
                }
            }
            throw FragmenterError.create(exports.FragmenterErrorCode.MaxModuleRetries, `max number of retries reached for module '${module.name}'`);
        });
    }
    tryDownloadAndInstallModule(module, moduleIndex, retryCount, fullModuleHash, move = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            downloader.on('progress', (p) => {
                ...
                this.emit('downloadProgress', module, Object.assign(Object.assign({}, p), { percent: pct }));
            });
            downloader.on('downloadInterrupted', (fromUserAction) => {
                this.emit('downloadInterrupted', module, fromUserAction);
            });
            downloader.on('error', (e) => this.emit('error', e));
            yield downloader.startDownload(this.options.temporaryDirectory);
            ...
            const moduleZipPath = path__default["default"].join(this.options.temporaryDirectory, `${module.name}.zip`);
            const extractDir = path__default["default"].join(this.options.temporaryDirectory, 'extract', module.name);
            this.emit('unzipStarted', module);
            yield decompressor.decompress(moduleZipPath, extractDir);
            this.emit('unzipFinished', module);
            if (move) {
                this.emit('copyStarted', module);
                yield this.moveOverExtractedFiles(module);
                this.emit('copyFinished', module);
                yield this.cleanupTempModuleFiles(module);
            }
            this.ctx.logTrace(`[FragmenterInstaller] Done downloading and installing module '${module.name}'`);
        });
    }
    cleanupTempModuleFiles(module) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ctx.logTrace(`[FragmenterInstaller] Cleaning up temporary module files for '${module.name}'`);
            const moduleZipPath = path__default["default"].join(this.options.temporaryDirectory, module.name, '.zip');
            const moduleExtractDir = path__default["default"].join(this.options.temporaryDirectory, 'extract', module.name);
            let moduleZipExists = false;
            try {
                yield lib$1.access(moduleZipPath);
            ...
            try {
                yield lib$1.access(moduleExtractDir);
            ...
            try {
                if (moduleZipExists) {
                    yield util$1.promisify(lib$1.rm)(moduleZipPath);
                }
                if (moduleExtractDirExists) {
                    yield util$1.promisify(lib$1.rm)(moduleExtractDir, { recursive: true });
                }
            }
            catch (e) {
    ...
    moveOverBackedUpFiles(module) {
        return __awaiter(this, void 0, void 0, function* () {
            const restoreDir = path__default["default"].join(this.options.temporaryDirectory, 'restore', module.sourceDir);
            const destModuleDir = path__default["default"].join(this.destDir, module.sourceDir);
            yield this.moveOverModuleFiles(module, restoreDir, destModuleDir);
        });
    }
    moveOverExtractedFiles(module) {
        return __awaiter(this, void 0, void 0, function* () {
            const extractedDir = path__default["default"].join(this.options.temporaryDirectory, 'extract', module.name);
            const destModuleDir = path__default["default"].join(this.destDir, module.sourceDir);
            yield this.moveOverModuleFiles(module, extractedDir, destModuleDir);
        });
    }
    moveOverModuleFiles(module, sourceDir, destModuleDir) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ctx.logInfo(`[FragmenterInstaller] Moving files from '${sourceDir}' -> '${destModuleDir}'`);
            const files = fsReaddirRecursive(sourceDir);
            let moved = 0;
            for (const file of files) {
                const absoluteSourcePath = path__default["default"].resolve(sourceDir, file);
                const absoluteDestPath = path__default["default"].resolve(destModuleDir, file);
                try {
                    yield lib$1.move(absoluteSourcePath, absoluteDestPath, { overwrite: true });
    ...
    ensureTempDirExists() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let tempDirExists;
                try {
                    yield lib$1.access(this.options.temporaryDirectory);
                    tempDirExists = true;
                }
                catch (e) {
                    tempDirExists = false;
                ...
                if (!tempDirExists) {
                    yield lib$1.mkdir(this.options.temporaryDirectory);
                }
            }
            catch (e) {
    ...
    ensureTempDirRemoved() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tempDirExists) {
                try {
                    yield util$1.promisify(lib$1.rm)(this.options.temporaryDirectory, { recursive: true });
                }
                catch (e) {
    ...
    ensureDestDirIsEmpty() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield util$1.promisify(lib$1.rm)(this.destDir, { recursive: true });
            }
            catch (e) {
                this.emit('error', '[FragmenterInstaller] Error while emptying dest directory');
            }
            try {
                yield util$1.promisify(lib$1.mkdir)(this.destDir);
            }
            catch (e) {
    ...
    backupExistingFiles() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const backupDir = path__default["default"].join(this.options.temporaryDirectory, 'restore');
            const files = fsReaddirRecursive(this.destDir);
            for (const file of files) {
                const absoluteSourcePath = path__default["default"].resolve(this.destDir, file);
                const absoluteDestPath = path__default["default"].resolve(backupDir, file);
                let alreadyExists = false;
                try {
                    yield lib$1.access(absoluteDestPath);
                    alreadyExists = true;
                }
                catch (e) {
                    // noop
    ...
    restoreBackedUpFiles() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const backupDir = path__default["default"].join(this.options.temporaryDirectory, 'restore');
            const files = fsReaddirRecursive(backupDir);
            for (const file of files) {
                const absoluteSourcePath = path__default["default"].resolve(backupDir, file);
                const absoluteDestPath = path__default["default"].resolve(this.destDir, file);
                try {
                    yield lib$1.move(absoluteSourcePath, absoluteDestPath, { overwrite: true });
                }
    ...
    finishInstall(installManifest) {
        return __awaiter(this, void 0, void 0, function* () {
            const canceled = this.ctx.signal.aborted;
            if (!canceled) {
                const manifestPath = path__default["default"].join(this.destDir, INSTALL_MANIFEST);
                this.ctx.logInfo(`[FragmenterInstaller] Writing install manifest to '${manifestPath}'`);
                yield lib$1.writeJSON(manifestPath, installManifest);
...
(function() {
    ...
    es5$1.defineProperty(Promise, "_unhandledRejectionCheck", {
        value: unhandledRejectionCheck
    });
    es5$1.defineProperty(Promise, "_unhandledRejectionClear", {
...
Promise.onPossiblyUnhandledRejection = function (fn) {
    ...
    possiblyUnhandledRejection = util$1.contextBind(context, fn);
};

Promise.onUnhandledRejectionHandled = function (fn) {
    var context = Promise._getContext();
    unhandledRejectionHandled = util$1.contextBind(context, fn);
};
...
var legacyHandlers = {
    unhandledrejection: {
        before: function() {
            var ret = util$1.global.onunhandledrejection;
            util$1.global.onunhandledrejection = null;
            return ret;
        },
        after: function(fn) {
            util$1.global.onunhandledrejection = fn;
        }
    },
    rejectionhandled: {
        before: function() {
            var ret = util$1.global.onrejectionhandled;
            util$1.global.onrejectionhandled = null;
            return ret;
        },
        after: function(fn) {
            util$1.global.onrejectionhandled = fn;
        }
    }
};
...
var fireDomEvent = (function() {
    var dispatch = function(legacy, e) {
        if (legacy) {
            ...
            try {
                fn = legacy.before();
                return !util$1.global.dispatchEvent(e);
            } finally {
                legacy.after(fn);
            }
        } else {
...
Promise.config = function(opts) {
    ...
    if ("asyncHooks" in opts && util$1.nodeSupportsAsyncResource) {
            ...
            if (last <= 8 && canEvaluate) {
                ...
                if (!ret._isFateSealed()) {
                    if (holder.asyncNeeded) {
                        var context = Promise._getContext();
                        holder.fn = util$1.contextBind(context, holder.fn);
                    }
...
function MappingPromiseArray(promises, fn, limit, _filter) {
    ...
    var context = Promise._getContext();
    this._callback = util$1.contextBind(context, fn);
...
function ReductionPromiseArray(promises, fn, initialValue, _each) {
    this.constructor$(promises);
    var context = Promise._getContext();
    this._fn = util$1.contextBind(context, fn);
...
var util$1 = util;
util$1.setReflectHandler(reflectHandler);
...
var getContext = util$1.isNode ? getContextDomain : getContextDefault;
util$1.notEnumerableProp(Promise, "_getContext", getContext);
var enableAsyncHooks = function() {
    getContext = getContextAsyncHooks;
    util$1.notEnumerableProp(Promise, "_getContext", getContextAsyncHooks);
};
var disableAsyncHooks = function() {
    getContext = getContextDomain;
    util$1.notEnumerableProp(Promise, "_getContext", getContextDomain);
};
...
Promise.prototype._then = function (
    ...
    if (!((bitField & 50397184) === 0)) {
        ...
        async$1.invoke(settler, target, {
            handler: util$1.contextBind(context, handler),
            promise: promise,
            receiver: receiver,
            value: value
        });
...
Promise.prototype._addCallbacks = function (
    ...
    if (index === 0) {
        ...
        if (typeof fulfill === "function") {
            this._fulfillmentHandler0 = util$1.contextBind(context, fulfill);
        }
        if (typeof reject === "function") {
            this._rejectionHandler0 = util$1.contextBind(context, reject);
        }
    } else {
        var base = index * 4 - 4;
        this[base + 2] = promise;
        ...
        if (typeof fulfill === "function") {
            this[base + 0] =
                util$1.contextBind(context, fulfill);
        }
        if (typeof reject === "function") {
            this[base + 1] =
                util$1.contextBind(context, reject);
        }
    }
...
const { basename, resolve } = path__default["default"];
...
SplitFile.prototype.splitFile = function (file, parts, dest) {
  ...
  // Validate parameters.
  if (parts < 1) {
    return bluebird_1.reject(new Error("Parameter 'parts' is invalid, must contain an integer value."));
  }

  return bluebird_1.promisify(fs__default["default"].stat)(file).then(function (stat) {
    if (!stat.isFile) {
      return bluebird_1.reject(new Error("Given file is not valid"));
    }
    if (!stat.size) {
      return bluebird_1.reject(new Error("File is empty"));
    }
    ...
    if (splitSize < 1) {
      return bluebird_1.reject(new Error("Too many parts, or file too small!"));
    }
...
SplitFile.prototype.mergeFiles = function (inputFiles, outputFile) {
  ...
  if (inputFiles.length <= 0) {
    return bluebird_1.reject(new Error("Make sure you input an array with files as first parameter!"));
  }

  var writer = fs__default["default"].createWriteStream(outputFile, {
    encoding: null,
  });

  return bluebird_1.mapSeries(inputFiles, function (file) {
    return new bluebird_1(function (resolve, reject) {
      var reader = fs__default["default"].createReadStream(file, { encoding: null });
    ...
    writer.close();
    return bluebird_1.resolve(outputFile);
  });
};
...
SplitFile.prototype.__splitFile = function (file, partInfo, dest) {
  ...
  return bluebird_1.mapSeries(partInfo, function (info) {
    return new bluebird_1(function (resolve, reject) {
      // Open up a reader
      var reader = fs__default["default"].createReadStream(file, {
        encoding: null,
        start: info.start,
        end: info.end - 1,
      });
      ...
      const outputFile = (filename) => {
        const writer = fs__default["default"].createWriteStream(filename);
    ...
    return bluebird_1.resolve(partFiles);
  });
};
...
const {Worker} = (() => {
	try {
		return require$$0__default$3["default"];
	} catch (_) {
		return {};
	}
})();
...
function pack(buildManifest) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const generateHashFromPath = (absolutePath, baseDir) => __awaiter(this, void 0, void 0, function* () {
            // The hash is undefined if the path doesn't exist.
            if (!lib$1.existsSync(absolutePath)) {
                return undefined;
            }
            const stats = lib$1.statSync(absolutePath);
            if (stats.isFile()) {
                const relativePath = path__default["default"].relative(absolutePath, baseDir);
                const normalizedPath = relativePath.replace(/\\/g, "/");
                return hasha_1(normalizedPath +
                    (yield hasha_1.fromStream(lib$1.createReadStream(absolutePath))));
            }
            else {
                const directoryPaths = lib$1
                    .readdirSync(absolutePath)
                    .map((i) => path__default["default"].join(absolutePath, i));
                return generateHashFromPaths(directoryPaths, baseDir);
            }
        });
        const generateHashFromPaths = (absolutePaths, baseDir) => __awaiter(this, void 0, void 0, function* () {
            const paths = [];
            for (const absolutePath of absolutePaths) {
                const baseName = path__default["default"].basename(absolutePath);
                const contentsHash = yield generateHashFromPath(absolutePath, baseDir);
                paths.push(hasha_1(baseName + contentsHash));
            }
            return hasha_1(paths.join(""));
        });
        const zip = (sourcePath, zipDest) => __awaiter(this, void 0, void 0, function* () {
            console.log("[FRAGMENT] Calculating CRC", {
                source: sourcePath,
                dest: zipDest,
            });
            const filesInModule = fsReaddirRecursive(sourcePath).map((i) => path__default["default"].resolve(sourcePath, i));
            const crcInfo = {
                hash: yield generateHashFromPaths(filesInModule, sourcePath),
            };
            yield lib$1.writeJSON(path__default["default"].join(sourcePath, SINGLE_MODULE_MANIFEST), crcInfo);
            console.log("[FRAGMENT] Creating ZIP", {
                source: sourcePath,
                dest: zipDest,
            });
            const zip = new lib.Zip();
            yield zip.addFolder(sourcePath);
            yield zip.archive(zipDest);
            const zipStat = yield lib$1.stat(zipDest);
            const doSplit = options.splitFileSize > 0 && zipStat.size > options.splitFileSize;
            let splitFileCount = 0;
            if (doSplit) {
                console.log(`[FRAGMENT] Splitting file ${path__default["default"].parse(zipDest).base} because it is larger than 1GB`);
                const files = yield splitFile.splitFileBySize(zipDest, options.splitFileSize);
                console.log(`[FRAGMENT] Split file ${path__default["default"].parse(zipDest).base} into ${files.length} parts`);
                splitFileCount = files.length;
                if (!options.keepCompleteModulesAfterSplit) {
                    lib$1.rmSync(zipDest);
                }
            }
            console.log("[FRAGMENT] Done writing zip", zipDest);
            const sizeUncompressed = filesInModule.reduce((accu, path) => accu + lib$1.statSync(path).size, 0);
        ...
        buildManifest.modules.forEach((moduleA) => {
            ...
            buildManifest.modules.forEach((moduleB) => {
                if (moduleA !== moduleB) {
                    const pathDiff = path__default["default"].relative(moduleA.sourceDir, moduleB.sourceDir);
        ...
        if (!lib$1.existsSync(buildManifest.baseDir)) {
            throw new Error("Base directory does not exist");
        }
        if (lib$1.existsSync(buildManifest.outDir)) {
            lib$1.rmdirSync(buildManifest.outDir, { recursive: true });
        }
        lib$1.mkdirSync(buildManifest.outDir, { recursive: true });
        ...
        try {
            ...
            ] = yield zip(tempDir, path__default["default"].join(buildManifest.outDir, FULL_FILE));
            // Zip Modules
            console.log("[FRAGMENT] Creating module ZIPs");
            for (const module of buildManifest.modules) {
                const sourcePath = path__default["default"].join(tempDir, module.sourceDir);
                const zipDest = path__default["default"].join(buildManifest.outDir, `${module.name}.zip`);
                const [hash, splitFileCount, completeFileSize, completeFileSizeUncompressed,] = yield zipAndDelete(sourcePath, zipDest);
                distributionManifest.modules.push(Object.assign(Object.assign({}, module), { hash,
                    splitFileCount,
                    completeFileSize,
            ...
            distributionManifest.base.files = fsReaddirRecursive(tempDir).map(toUnixPath);
            const zipDest = path__default["default"].join(buildManifest.outDir, BASE_FILE);
            [
            ...
            ] = yield zipAndDelete(tempDir, zipDest);
            yield lib$1.writeJSON(path__default["default"].join(buildManifest.outDir, MODULES_MANIFEST), distributionManifest);
            return distributionManifest;
        }
        catch (e) {
            if (!options.noBaseCopy)
                yield lib$1.rmdirSync(tempDir, { recursive: true });
            throw e;
        }
    });
}

exports.FragmenterContext = FragmenterContext;
exports.FragmenterError = FragmenterError;
exports.FragmenterInstaller = FragmenterInstaller;
exports.FragmenterUpdateChecker = FragmenterUpdateChecker;
exports.UnrecoverableErrors = UnrecoverableErrors;
exports.getCurrentInstall = getCurrentInstall;
exports.pack = pack;
